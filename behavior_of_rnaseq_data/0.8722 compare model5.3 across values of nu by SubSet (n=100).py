...
fit_nu2 = models.cached_stan_fit(file=model, data=stan_data2, model_name=model_name)
...
fit_nu3 = models.cached_stan_fit(file=model, data=stan_data3, model_name=model_name)
...
fit_nu4 = models.cached_stan_fit(file=model, data=stan_data4, model_name=model_name)
...
fit_nu5 = models.cached_stan_fit(file=model, data=stan_data5, model_name=model_name)
...
fit_nu6 = models.cached_stan_fit(file=model, data=stan_data6, model_name=model_name)
